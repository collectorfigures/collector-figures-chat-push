...
webpush_app_id=com.collectorfigures.chat.web
public_endpoint=https://chat-push.collectorfigures.com/_matrix/push/v1/notify
upstream_tag=v0.17.0
upstream_tag_object=621dbe9feec4a8700fadf933b17aecba3847445d
upstream_commit=53c25a82f85739eb58f2c95b9483f61ac8deedc4
license=AGPL-3.0-only
```

Collector Figures adds a `cfs_minimal` WebPush payload mode, redacts Push subscription credentials from logs, and
ships an exact browser endpoint allowlist. See [MODIFICATIONS.md](./MODIFICATIONS.md) and
